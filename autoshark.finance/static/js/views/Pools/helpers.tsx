...
import { Dividend, Pool } from 'state/types'
...
export const getAprData = (pool: Pool | Dividend, performanceFee: number) => {
...
export const getPoolBlockInfo = (pool: Pool | Dividend, currentBlock: number) => {
