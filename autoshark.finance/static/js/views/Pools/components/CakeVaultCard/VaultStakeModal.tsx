...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from '@autoshark-finance/uikit'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({ pool, stakingMax, isRemovingStake = false, onDismiss }) => {
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    ...
    // trigger withdrawAll function if the withdrawal will leave 0.000001 JAWS or less
    ...
    if (isWithdrawingAll) {
      try {
        ...
        if (receipt.status) {
          toastSuccess(t('Unstaked!'), t('You have withdrawn successfully'))
          setPendingTx(false)
          onDismiss()
  ...
  return (
    ...
    >
      ...
      <BalanceInput
        ...
        currencyValue={cakePriceBusd.gt(0) && `~$ ${usdValueStaked || 0}`}
      ...
      <Slider
        thumbButtImgSrc="/images/shark-butt-thumb.png"
        thumbImgSrc="/images/shark-thumb.png"
        min={0}
        max={100}
        value={percent}
