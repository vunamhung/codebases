...
const Wrapper = styled(Box)<{ maxHeight: string }>`
  ...
  & :nth-child(4) {
    animation: ${floatingAnim('0', '10px')} 3s ease-in-out infinite;
  ...
  & :nth-child(6) {
    animation: ${floatingAnim('10px', '12px')} 5s ease-in-out infinite;
    animation-delay: 0s;
  }
`
...
const CompositeImage: React.FC<ComponentProps> = ({ path, attributes, maxHeight = '100%' }) => {
  return (
