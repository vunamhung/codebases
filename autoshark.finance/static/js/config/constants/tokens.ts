...
export const TOKEN_IMAGE_URL_OVERRRIDES: string[] = [
...
export const JAWS: { [chainId: number]: Token } = {
...
const tokens = {
  ...
  cmerl: {
    symbol: 'cMERL',
    address: {
      56: '0x337bC105a97613b5a26f9641a5327c2ebA52AEaC',
      // 97: '0xa35062141Fa33BCA92Ce69FeD37D0E8908868AAe',
    },
    decimals: 18,
    projectLink: 'https://autoshark.finance/',
  ...
  nova: {
    ...
    decimals: 18,
    projectLink: 'https://app.shibanova.io/',
  },
  zmbe: {
    symbol: 'ZMBE',
    address: {
    ...
    decimals: 18,
    projectLink: 'https://www.rugzombie.io',
  },
  nftart: {
    symbol: 'NFTART',
    address: {
    ...
    decimals: 9,
    projectLink: 'https://www.nft-art.finance/',
  },
  baby: {
    symbol: 'BABY',
    address: {
  ...
  fts: {
    ...
    decimals: 18,
    projectLink: 'https://fortress.loans/',
  },
  wnow: {
    symbol: 'WNOW',
    address: {
  ...
  meow: {
    symbol: 'MEOW',
    address: {
      56: '0xe8658b07c555e9604329a6a0a82ff6d9c6f68d2f',
      97: '',
    },
    decimals: 18,
  ...
  dep: {
    ...
    decimals: 18,
    projectLink: 'https://playmining.com/',
  },
  cos: {
    symbol: 'COS',
    address: {
  ...
  eros: {
    ...
    decimals: 18,
    projectLink: 'https://erosswap.finance/',
  },
  byg: {
    symbol: 'BYG',
    address: {
...
// export const SWAP_WHITELISTED_TOKENS: string[] = [
//   getAddress(tokens.jaws.address),
//   getAddress(tokens.cake.address),
//   getAddress(tokens.wbnb.address),
//   getAddress(tokens.eth.address),
//   getAddress(tokens.btcb.address),
