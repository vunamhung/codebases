import { getNFTSeries1Address, getNFTSeries2Address, getNFTHammer1Address } from 'utils/addressHelpers'
import { NftSource, NftType, NftRarities, NftSeries } from './types'
...
export const RARITY_ARRAY = ['1', '2', '3', '4', '5']

export const RARITY_MAP: NftRarities = {
  1: 'common',
  2: 'uncommon',
  3: 'rare',
  4: 'epic',
...
export const REVERSE_SERIES_MAP = {
  both: null,
  hammers: getNFTHammer1Address(),
  sharks: getNFTSeries1Address(),
  sharks2: getNFTSeries2Address(),
}
...
export const RARITY_GLOW_LIST = ['rare', 'epic', 'legendary']
...
//   {
//     name: 'Churro',
//     description: "Don't let that dopey smile deceive you... Churro's a master JAWS chef!",
//     images: {
//       lg: 'churro-lg.png',
//       md: 'churro-md.png',
//       sm: 'churro-sm.png',
...
//   {
//     name: 'Dollop',
//     description: "Nommm... Oh hi, I'm just meditating on the meaning of JAWS.",
//     images: {
//       lg: 'dollop-lg.png',
//       md: 'dollop-md.png',
//       sm: 'dollop-sm.png',
...
//   {
//     name: 'Twinkle',
//     description: "Three guesses what's put that twinkle in those eyes! (Hint: it's JAWS)",
//     images: {
//       lg: 'twinkle-lg.png',
//       md: 'twinkle-md.png',
//       sm: 'twinkle-sm.png',
