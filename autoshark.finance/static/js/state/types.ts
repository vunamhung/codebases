...
export interface Farm extends FarmConfig {
  ...
  depositFees?: string
  farmBoostRate?: SerializedBigNumber
  userData?: {
    allowance: string
    tokenBalance: string
...
export interface Vault extends VaultConfig {
  ...
  userData?: {
    ...
    vaultBoostRate?: SerializedBigNumber
  }
}
...
export interface Dividend extends DividendConfig {
  totalStaked?: BigNumber
  stakingLimit?: BigNumber
  startBlock?: number
  endBlock?: number
...
export interface Auction {
  ...
  myBidBalance: string
  tokenData?: {
    lastPrice?: string // last transacted price in WEI
    lastToken?: string // last transacted token, BNB or JAWS
  }
}
