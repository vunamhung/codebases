...
import { Modal, Text, LinkExternal, Flex, Box } from '@autoshark-finance/uikit'
...
const ApyCalculatorModal: React.FC<ApyCalculatorModalProps> = ({
  ...
  const oneThousandDollarsWorthOfToken = 1000
      ...
      <Box>
        <Flex mb="8px" justifyContent="space-between">
          <Text small color="textSubtle">
            {!isFarm ? t('APY incl. rewards') : t('APY')}
          </Text>
          <Text small>{displayApr}%</Text>
        </Flex>
        <Flex mb="24px" justifyContent="space-between">
          <Text small color="textSubtle">
          {!isFarm ? t('APR (yield only)') : t('APR')}
          </Text>
        ...
        <Box mb="28px" maxWidth="280px" p="4px">
          <BulletList>
            ...
            {/* {isFarm && (
              <li>
                <Text fontSize="12px" textAlign="center" color="textSubtle" display="inline">
                  {t('LP rewards: 0.10% trading fees, distributed proportionally among LP token holders.')}
                </Text>
              </li>
            )} */}
            <li>
